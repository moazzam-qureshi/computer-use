...
SEED_PROSE = (
    ...
    "(b) Hourly post must have an upper rate of AT LEAST 25 USD/hr to pass. Look at "
    "the TOP of the rate range. A $5-$20/hr post FAILS (top is $20, under $25). "
    "A $15-$50/hr post PASSES (top is $50, well above $25). A flat $30/hr post PASSES. "
    "A flat $15/hr post FAILS. There is NO upper limit, expensive jobs are fine. "
    "We REJECT a post only when its top rate is too LOW, never when it pays well. "
    ...
    "NON-NEGOTIABLE APPLICATION-FORMAT REJECTS, REJECT if the post requires ANY of: "
    "(i) A Loom video, Vidyard video, intro video, screen recording, or any pre-application video submission. "
    "(ii) A take-home test, coding assessment, Upwork skills test, or any unpaid pre-engagement task. "
    "(iii) 'Book a call before applying' or any calendar-link-only application flow that inverts the normal proposal review. "
    "(iv) 'Must be available right now' / 'live within the next hour' / synchronous-now requirements (we are async by design). "
    "The non-negotiable floor exists because tiny-budget AI jobs cost the same Doc + cover-letter "
    "generation as serious ones and dilute our signal, and the application-format rejects exist because "
    "we cannot fulfill them through the automated bidding flow. "
